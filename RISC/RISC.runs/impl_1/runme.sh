...
HD_PWD='D:/An3/An3 Sem1/SSC/RISC/RISC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log implem_RISC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source implem_RISC.tcl -notrace
