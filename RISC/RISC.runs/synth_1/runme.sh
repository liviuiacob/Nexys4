...
HD_PWD='D:/An3/An3 Sem1/SSC/RISC/RISC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log implem_RISC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source implem_RISC.tcl
